            ...
            <div class="col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">${institutionInfo.name}</h6>
                    </div>
                    <div class="card-body row">
                        <div class="col-lg-11">
                            email: ${institutionInfo.description} <br/>
                        </div>
                        <div class="col-lg-1">
                            <a href="/admin/institution/delete/${institution.id}" class="btn btn-danger">Usuń</a>
                        </div>
                    </div>
                </div>
            </div>
