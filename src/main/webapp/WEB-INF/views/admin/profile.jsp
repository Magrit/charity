            ...
            <div class="col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">${currentUser.firstName} ${currentUser.lastName}</h6>
                    </div>
                    <div class="card-body row">
                        <div class="col-lg-10">
                            email: ${currentUser.email} <br/>
                            nr telefonu: ${currentUser.phoneNumber} <br/>
                        </div>
                        <div class="col-lg-2">
                            <a href="/admin/profile/edit" class="btn btn-primary">Edytuj</a>
                            <a href="/admin/password/edit" class="btn btn-success">Zmień hasło</a>
                        </div>
                    </div>
                </div>
            </div>
